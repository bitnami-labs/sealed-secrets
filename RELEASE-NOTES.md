...
- [Prometheus](#prometheus)
  ...
  - [v0.11.0](#v0110)
    ...
    - [For those who choose the name and namespace after sealing the secret](#for-those-who-choose-the-name-and-namespace-after-sealing-the-secret)
  ...
  - [v0.9.7](#v097)
    ...
    - [Allow overwriting existing secrets](#allow-overwriting-existing-secrets)
    - [Changelog](#changelog-24)
  - [v0.9.6](#v096)
    - [Announcements](#announcements-11)
    - [Preliminary support for running multiple controllers](#preliminary-support-for-running-multiple-controllers)
    - [Changelog](#changelog-25)
  - [v0.9.5](#v095)
    - [Announcements](#announcements-12)
    - [Changelog](#changelog-26)
  - [v0.9.4](#v094)
    - [Announcements](#announcements-13)
  ...
  - [v0.9.2](#v092)
    ...
    - [Periodic key renewal and offline certificates](#periodic-key-renewal-and-offline-certificates)
    - [Changelog](#changelog-29)
  - [v0.9.1](#v091)
  - [v0.9.0](#v090)
  - [Announcement](#announcement)
    - [Private key renewal](#private-key-renewal)
    - [Pre-v0.7.0 clients](#pre-v070-clients)
    - [Update items](#update-items)
    - [Changelog](#changelog-30)
  - [v0.8.3](#v083)
    - [Announcements](#announcements-16)
