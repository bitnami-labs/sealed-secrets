...
Those cryptographic API are known to provide a good cryptographic entropy, which are not vulnerable to cryptographic attacks unless the seed is known.

For further information about those API :
