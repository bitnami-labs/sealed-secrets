...
func defaultSealedSecretInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewSealedSecretInformer(client, v1.NamespaceAll, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
}

func (f *sealedSecretInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sealed_secrets_v1alpha1.SealedSecret{}, defaultSealedSecretInformer)
}
